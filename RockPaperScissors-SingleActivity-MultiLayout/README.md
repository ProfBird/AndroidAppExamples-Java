This version of Rock, Paper, Scissors has one activity and two layouts-- one for portrait and another for landscape orientation. It was written in Java using Android Studio.
